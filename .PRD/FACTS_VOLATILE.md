...
| 항목 | 값 | 확인 명령 | 검증일 |
|---|---|---|---|
| Claude Code 버전 | ⚠️ `2.1.233` (2026-08-09 실측 `2.1.226`에서 변경됨 — research preview 특성상 회귀 가능성 있음, R2) | `claude --version` | 2026-08-17 |
...
| U9 | 출력 **마스킹 패턴** 최종 목록 — 최소 봇 토큰 형식(`숫자:영문숫자`) | 실측 후 확정 | Phase 1 (C6) |
